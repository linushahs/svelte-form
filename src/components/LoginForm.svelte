<script lang="ts">
  ...
  const handleSubmitClick = () => {
    try {
      const result = signinformSchema.parse(formValues);
      loginFormState.set(result);
...
<div class="grid">
  <form
    on:submit|preventDefault={handleSubmitClick}
  ...
  >
    ...
    <div class="form__field">
      <div class="">
        <label for="login__email" class={formErrors.email && "error"}
          ><svg class="icon">
    ...
    <div class="form__field">
      <div>
        <label for="login__password" class={formErrors.password && "error"}
          ><svg class="icon">
